...
import co.edu.eam.disenosoftware.biblioteca.model.requests.BorrowRequest;
...
public class BorrowsController {
   ...
   */
  @PostMapping
  public void borrowBook(@RequestBody BorrowRequest borroRequest) {
    service.borrowBook(borroRequest.getBookCode(),borroRequest.getUserId());
  }
