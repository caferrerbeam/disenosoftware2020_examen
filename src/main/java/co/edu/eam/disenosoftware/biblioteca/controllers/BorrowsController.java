...
import co.edu.eam.disenosoftware.biblioteca.model.requests.RequestBorrowBook;
...
public class BorrowsController {
   ...
   */
  @PostMapping
  public void borrowBook(@RequestBody RequestBorrowBook requestBorrowBook) {
    borrowService.borrowBook(requestBorrowBook.getBookCode(), requestBorrowBook.getUserId());
  }
